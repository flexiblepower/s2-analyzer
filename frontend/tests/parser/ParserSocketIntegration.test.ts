...
describe("WebSocketClient and Parser Integration", () => {
  ...
  describe("onReceive", () => {
    ...
    test("IT-02: should return the Handshake message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "Handshake", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
      ...
      expect(client.parser.messageMap[0].message_type).toBe(
    ...
    test("IT-03: should return HandshakeResponse message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "HandshakeResponse", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-04: should return InstructionStatusUpdate message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "InstructionStatusUpdate", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-06: should return PowerMeasurement message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "PowerMeasurement", "message_id": "46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-07: should return ReceptionStatus message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: RM battery1][Receiver: CEM cem_mock] Message: {"message_type": "ReceptionStatus", "subject_message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "status": "OK"}';
    ...
    test("IT-08: should return ResourceManagerDetails message type", () => {
      const messageString =
        "2024-03-22 12:50:53 [Message buffered][Sender: RM battery1][Receiver: CEM cem_mock] Message: {'message_type': 'ResourceManagerDetails', 'message_id': '2d717c61-8500-4e8f-87a8-114b51acc08b', 'resource_id': '0309eaef-4fbb-4c9c-aa90-58bde4f4b07c', 'name': 'battery1', 'roles': [{'role': 'ENERGY_STORAGE', 'commodity': 'ELECTRICITY'}], 'manufacturer': 'APC', 'model': 'SMT500I', 'serial_number': 'kellox', 'firmware_version': '1.2.5', 'instruction_processing_delay': 100, 'available_control_types': ['FILL_RATE_BASED_CONTROL'], 'currency': 'EUR', 'provides_forecast': False, 'provides_power_measurement_types': ['ELECTRIC.POWER.L1']}";
    ...
    test("IT-09: should return RevokeObject message type", () => {
      const messageString =
        '2024-03-11 13:29:10 [Message received][Sender: RM battery1][Receiver: CEM cem_mock] Message: {"message_type": "RevokeObject", "message_id": "3fd3fd3", "object_type": "FRBC.Instruction", "object_id":"7dd55ca8-f15c-4cad-adf5-154d11a9a2e1"}';
    ...
    test("IT-10: should return SelectControlType message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "SelectControlType", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-11: should return SessionRequest message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "SessionRequest", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-12: should return FRBC.ActuatorStatus message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.ActuatorStatus", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-13: should return FRBC.FillLevelTargetProfile message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.FillLevelTargetProfile", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-14: should return FRBC.Instruction message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.Instruction", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-15: should return FRBC.LeakageBehaviour message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.LeakageBehaviour", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-16: should return FRBC.StorageStatus message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.StorageStatus", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
    ...
    test("IT-18: should return FRBC.TimerStatus message type", () => {
      const messageString =
        '2024-03-22 12:50:53 [Message received][Sender: CEM cem_mock][Receiver: RM battery1] Message: {"message_type": "FRBC.TimerStatus", "message_id": "00ef6f72-257c-46a5-a656-07887903eb09", "role": "CEM"}';
