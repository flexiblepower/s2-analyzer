        ...
        <>
            <div onClick={()=>props.setTrigger(false)}
                ...
                <div onClick={(e) => e.stopPropagation()}
                     ...
                     `}>
                    <h2 className="text-lg font-black text-gray-800 justify-center items-center flex">{props.message.message_type}</h2>
                    <button
                    ...
                    <div className="props-list">
                        <table className="shadow-2xl font-[Calibri] border-2 border-blue-900">
                            ...
                            {keys.map((key, index) =>
                                <tr key={index} className={`${index % 2 == 0 ? "bg-blue-500" : "bg-blue-300"}`}>
